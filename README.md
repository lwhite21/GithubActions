[![Run App Logan White](https://github.com/lwhite21/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/lwhite21/GithubActions/actions/workflows/run-app.yaml)
